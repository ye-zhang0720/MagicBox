...
// information
#define APP_INFORMATION_USE 1
#if APP_INFORMATION_USE
#include "app/information/information.h"
#endif

// 路由器信息显示
#define APP_ROUTER_MONITOR_USE 1
#if APP_ROUTER_MONITOR_USE
#include "app/router_monitor/router_monitor.h"
#endif

// OTA
#define APP_OTA_USE 1
#if APP_OTA_USE
#include "src/app/ota/ota.h"
#endif
