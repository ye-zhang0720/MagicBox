...
"<label id='flash' for='file'>Flash容量：</label><br>"
    ...
    function getstatus() {
            ...
            if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                ...
                document.getElementById("occu").value = response.software
                document.getElementById("move").value = response.hardware
                document.getElementById("signal_limition").value = response.flash
            }
            }
