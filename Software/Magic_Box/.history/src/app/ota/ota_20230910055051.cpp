    ...
    ESP.restart(); },
        []()
        {
            ...
            else if (upload.status == UPLOAD_FILE_WRITE)
            {
                ...
                size_t a = upload.totalSize / Update.size();
                run_data->upSize = (int) upload.totalSize;
                run_data->totalSize = (int)Update.size();
                run_data->precent =  (int)(run_data->upSize / run_data->totalSize);
                 Serial.printf("1Update  %u   %u   %u  %d\n", upload.totalSize, Update.size(), a,  run_data->upSize);
