...
//  "   var response = JSON.parse(data);"
    "                         document.getElementById('software')[0].innerHTML = '软件版本： '+data.software;"
    "                document.getElementById('hardware')[0].innerHTML = '硬件版本： '+data.hardware;"
    "                document.getElementById('flash')[0].innerHTML = 'Flash容量： '+data.flash;"
