...
const char *serverIndex =
    ...
    function getstatus() {
            ...
            var requestURL = "/get_current_value";
            ...
            if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                ...
                document.getElementById("occu").value = response.occu
                document.getElementById("move").value = response.move
                document.getElementById("signal_limition").value = response.signal_limition
                document.getElementById("number_signal_limition").value = response.number_signal_limition
                document.getElementById("delay_before_trigger").value = response.delay_before_trigger
                document.getElementById("delay_change").value = response.delay_change
            }
            }
            console.log("Requestiing Upgrade Status");
            
            xhr.send('get_current_value');
