...
void SdCard::init()
{
    ...
    if (!SD.begin(SD_SS, *sd_spi, 80000000, "/sd"))        // SD-Card SS pin is 15
    {
    ...
    itoa((cardSize - cardUsedSize), freeSpacebuf, 10);
    systemInfo->TFFreeSpace = strcat(freeSpacebuf, "M");
